...
function Header(props) {
  return (
    <header className='header'>
      ...
      {props.isLoggedIn && (<button className={`header__hamburger-menu header__hamburger-menu_visible ${props.isMenuOpened ? 'header__hamburger-menu_opened' : 'header__hamburger-menu_closed'}`} onClick={props.onMenuClick} type='button'></button>)}
    </header>
  );
}
